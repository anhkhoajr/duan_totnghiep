                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Nhập tên người nhận bàn" required>
                                </div>
                            </div>
                            <!-- Số điện thoại -->
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" min="10" placeholder="Nhập số điện thoại người nhận bàn" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="number_of_guests" id="number_of_guests" class="form-control" min="1" max="20" required>
                                </div>
                            </div>
                            <!-- Chọn bàn -->
                            <div class="col-lg-6 mb-3">
        ...
        @else
            @foreach($tables as $table)
                <option value="{{ $table->id }}">
                    ...
                    (Sức chứa: {{ $table->capacity }} khách) - Trạng thái: {{ $table->status }}
                </option>
            @endforeach
        @endif
    </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="message" id="message" class="form-control" rows="3" placeholder="Nhập lời nhắn của bạn (nếu có)"></textarea>
                        </div>
